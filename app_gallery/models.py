...
class Hashtag(models.Model):
    ...
    hashtag = models.CharField('Tag', max_length=50, unique=True)
...
class Picture(models.Model):
    ...
    thumbnail = models.ImageField(upload_to=thumbnail_file_path, blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
        ...
        """Check if the picture has thumbnail, in case it doesnt have it will create one"""
